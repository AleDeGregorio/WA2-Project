...
class WebSecurityConfig(
    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        http.csrf().disable()
            ...
            .requestMatchers(HttpMethod.GET,"/chat/**").hasAnyRole(ADMIN, MANAGER,EXPERT,  CUSTOMER)
            .requestMatchers(HttpMethod.GET,"/chat/ticket/**").hasAnyRole(ADMIN, MANAGER,EXPERT, CUSTOMER)
            .requestMatchers(HttpMethod.POST,"/ticket/chat/message").hasAnyRole(ADMIN, MANAGER,EXPERT,  CUSTOMER)
            .requestMatchers(HttpMethod.POST,"/attachment").hasAnyRole(ADMIN, MANAGER,EXPERT,  CUSTOMER)
            .requestMatchers(HttpMethod.GET,"/attachment/message/**").hasAnyRole(ADMIN, MANAGER,EXPERT,  CUSTOMER)
            //fine da cancellare
