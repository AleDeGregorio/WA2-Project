INSERT INTO public.customer (id, name, role, surname, address, city, email) VALUES ('056d235a-8eaa-41fc-8d2a-adaedcf317c7', 'Mario', 'CUSTOMER', 'Rossi', 'Via Roma, 22', 'Torino', 'mariorossi@polito.it');
INSERT INTO public.customer (id, name, role, surname, address, city, email) VALUES ('452d3eb7-7952-48ac-9ab0-e5bdbecf333a', 'Angela', 'CUSTOMER', 'Bianchi', 'Via Garibaldi, 57', 'Palermo', 'angelabianchi@polito.it');
INSERT INTO public.customer (id, name, role, surname, address, city, email) VALUES ('2bd77583-af4e-4680-a666-59c3b785c8b8', 'Luca', 'CUSTOMER', 'Neri', 'Via Mazzini, 15', 'Roma', 'lucaneri@polito.it');
INSERT INTO public.customer (id, name, role, surname, address, city, email) VALUES ('6a3fe4d1-a3b9-4cf1-b818-aa6d149dddf0', 'Sofia', 'CUSTOMER', 'Verdi', 'Via Cavour, 91', 'Milano', 'sofiaverdi@polito.it');
INSERT INTO public.customer (id, name, role, surname, address, city, email) VALUES ('6719b943-cf2e-4f8d-a2ed-8cd2be30737b', 'Giorgio', 'CUSTOMER', 'Gialli', 'Corso Francia, 1', 'Cagliari', 'giorgiogialli@polito.it');
...
INSERT INTO public.expert (id, name, role, surname, email, fields) VALUES ('5ecf9484-eb6d-4470-afaf-f7d935c77ccd', 'Paolo', 'EXPERT', 'Russo', 'paolorusso@polito.it', 'Smartphone');
INSERT INTO public.expert (id, name, role, surname, email, fields) VALUES ('526fdd4a-788a-4b3b-9444-0844620beb93', 'Marta', 'EXPERT', 'Ferrari', 'martaferrari@polito.it', 'PC');
INSERT INTO public.expert (id, name, role, surname, email, fields) VALUES ('e743b973-d610-4206-92c3-4e1c1548e995', 'Daniele', 'EXPERT', 'Esposito', 'danieleesposito@polito.it', 'Console, Smartphone');
INSERT INTO public.expert (id, name, role, surname, email, fields) VALUES ('aa929dd8-bb2b-4823-93eb-728c98080f19', 'Beatrice', 'EXPERT', 'Romano', 'beatriceromano@polito.it','Fridge, Smart TV');
INSERT INTO public.expert (id, name, role, surname, email, fields) VALUES ('b326e786-7f41-40a1-a398-e77088635097', 'Michele', 'EXPERT', 'Ricci', 'michelericci@polito.it','PC, Smartphone');

INSERT INTO public.manager (id, name, role, surname, email, department) VALUES ('af153852-ce10-49ee-85ad-6100e7371875', 'Dario', 'MANAGER', 'Greco', 'dariogreco@polito.it', 'dep2');
