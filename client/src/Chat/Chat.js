                        ...
                        {message.attachments.length > 0 && (
                            <ul>
                                {message.attachments.map((att, index) => (
                                    <li key={index}>
                                        <img src={"data:image/png;base64,"+att.imageData}
                                             alt="Attached Image"
